    ...
    {!loading &&
      (filteredMeetings.length > 0
        ? filteredMeetings.map((meeting) => (
            <IonRouterLink key={meeting._id} routerLink={`/bottomtabs/individualmeeting/${meeting._id}`}>
        ...
        : !noMeetingsToday && <IonItem>No meetings for selected date</IonItem>)}
  </IonList>
</div>


          <div style={{ position: 'fixed', bottom: 5, width: '90%', zIndex: 1, marginLeft: '18px' }}>
